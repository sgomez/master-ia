...
class Pez(Animal):
    def __init__(self):
        Animal.__init__(self,nombre='pez')
        ...
        self.add_rule(rules.ReglaIgual('r9', self.get_attribute('aletas'), True))
        self.add_rule(rules.ReglaIgual('r10', self.get_attribute('patas'), 0))
